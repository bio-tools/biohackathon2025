...
from the JSON schema at https://raw.githubusercontent.com/bio-tools/biotoolsSchema/refs/heads/main/jsonschema/biotoolsj.json.
"""

# generated by datamodel-codegen:
#   filename:  tool_root.json
#   timestamp: 2026-08-18T10:52:32+00:00
...
class TopicItem(BaseModel):
    ...
    uri: Optional[constr(pattern=r'^(http\://edamontology\.org/topic_[0-9]{4,4})$')] = (
        Field(
            None,
...
class ElixirCommunityEnum(Enum):
    ...
    Research_Data_Management = 'Research Data Management'
...
class OperationItem(BaseModel):
    ...
    uri: Optional[
        constr(pattern=r'^(http\://edamontology\.org/operation_[0-9]{4,4})$')
    ] = Field(
        None,
...
class EDAMdata(BaseModel):
    ...
    uri: Optional[constr(pattern=r'^(http\://edamontology\.org/data_[0-9]{4,4})$')] = (
        Field(
            None,
...
class EDAMformat(BaseModel):
    ...
    uri: Optional[
        constr(pattern=r'^(http\://edamontology\.org/format_[0-9]{4,4})$')
    ] = Field(
        None,
...
class DataType(BaseModel):
    ...
    data: EDAMdata = Field(
        ..., description='Type of data: EDAM Data term(s).', title='EDAM Data concept'
    )
...
class VersionType(
    ...
    root: constr(
        pattern=r'^([ \(-\)\+-\.0-;A-Z_a-z  ᠎ -   　]*)$', min_length=1, max_length=100
    ) = Field(
        ...,
...
class LinkItem(BaseModel):
    ...
    note: Optional[TextType] = Field(
        None, description='Comment about the link.', title='Link comment'
    )
...
class DownloadItem(BaseModel):
    ...
    type: Type1 = Field(
        ..., description='Type of download that is linked to.', title='Download type'
    )
    note: Optional[TextType] = Field(
        None, description='Comment about the download.', title='Downlad comment'
    )
...
class PublicationItem(BaseModel):
    ...
    doi: Optional[constr(pattern=r'^(10\.[0-9]{4,9}/[\(-\)\--<>A-\[\]_a-z]+)$')] = (
        Field(
            None,
    ...
    note: Optional[TextType] = Field(
        None, description='Comment about the publication.', title='Publication comment'
    )
    version: Optional[VersionType] = Field(
        None,
...
class CreditItem(BaseModel):
    ...
    orcidid: Optional[
        Union[
            constr(
                pattern=r'^(http\://orcid\.org/[0-9]{4,4}\-[0-9]{4,4}\-[0-9]{4,4}\-[0-9]{3,3}[0-9X])$'
            ),
            constr(
                pattern=r'^(https\://orcid\.org/[0-9]{4,4}\-[0-9]{4,4}\-[0-9]{4,4}\-[0-9]{3,3}[0-9X])$'
            ),
        ]
    ] = Field(
        None,
    ...
    gridid: Optional[constr(pattern=r'^(grid[\w\D][0-9]{4,}[\w\D][0-9a-f]{1,2})$')] = (
        Field(
            None,
...
class ToolModel(BaseModel):
    ...
    biotoolsCURIE: Optional[constr(pattern=r'^(biotools\:[\--\.0-9A-Z_a-z]*)$')] = (
        Field(
            None,
    ...
    cost: Optional[Cost] = Field(
        None, description='Monetary cost of acquiring the software.', title='Cost'
    )
